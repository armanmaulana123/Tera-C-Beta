                        ...
                        <ul class="list-unstyled list-unstyled-border">
                            <?php if (count($produk) > 0) { ?>
                                <?php foreach ($produk as $p) { ?>
                                    <li class="media">
                                        <img class="mr-3 rounded" width="55" src="<?= base_url('assets/images/foto_produk/') . $p['foto_terasi']; ?>" alt="product">
                                        <div class="media-body">
                                            <!-- <div class="float-right">
                                                <div class="font-weight-600 text-muted text-small">86 Sales</div>
                                            </div> -->
                                            <div class="media-title"><?= $p['nama_terasi'] ?></div>
                                            <div class="mt-1">
                                                <div class="budget-price">
                                                    <div class="budget-price-square bg-danger" data-width="10%"></div>
                                                    <div class="budget-price-label"><?= "Rp." . number_format($p['harga_terasi'], 0, ',', '.'); ?></div>
                                                </div>
                                                <div class="budget-price">
                                                    <div class="budget-price-square bg-danger" data-width="10%"></div>
