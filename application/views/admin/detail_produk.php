    ...
    <section class="section">
        ...
        <article class="article article-style-c">
            <div class="article-header">
                <div class="article-image" data-background="<?= base_url('assets/images/foto_produk/') . $data_produk['foto_terasi'] ?>">
                </div>
            </div>
            <div class="article-details">
                ...
                <div class="article-title">
                    <h3 class="text-primary"><?= $data_produk['nama_terasi'] ?></h3>
                </div>
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Ukuran Barang : <?= $data_produk['ukuran_terasi'] ?> Cm</li>
