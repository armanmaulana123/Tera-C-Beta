            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php $no = 1;
                        foreach ($status as $s) { ?>
                            <?php if ($produk['status_pembuatan'] == $s['id_statusPembuatanTerasi']) { ?>
                                <div class="alert alert-success" role="alert">
                                    <?= $no++ ?>. <?= $s['nama_statusPembuatanTerasi'] ?>.
                                </div>
                            <?php } else { ?>
                ...
                <?php if ($produk['status_pembuatan'] == 7) { ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            <center>Masukkan Jumah Terasi Yang Dihasilkan Dari Proses Pembuatan Saat Ini, Beserta Nominal Pengeluaran Untuk Membuat Terasi.</center>
                            <form action="<?= base_url('admin/update_produk') ?>" method="POST">
                                <center>
                                    <div class="row mt-3">
