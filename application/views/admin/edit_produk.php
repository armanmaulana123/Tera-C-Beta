                ...
                <form method="POST" action="<?= base_url('admin/proses_edit_produk') ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input id="nama" type="text" class="form-control" name="nama" value="<?= $data_produk['nama_terasi'] ?>" required>
                        </div>
                        <div class="form-group col-6">
                            <label for="no_telp">Ukuran Terasi</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="ukuran_terasi" aria-describedby="basic-addon2" value="<?= $data_produk['ukuran_terasi'] ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="harga_produk" value="<?= $data_produk['harga_terasi'] ?>" aria-describedby="basic-addon2" required>
