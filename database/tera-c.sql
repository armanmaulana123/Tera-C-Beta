...
(3, 'KP_nvX1', 'Terasi 1 Kg', 1, '15', '20', '5000', 'KP_nvX1.jpg', 8, '2022-05-05', '2022-06-07'),
(4, 'KP_QF92', 'Terasi 2 Kg', 1, '20', '14', '10000', 'KP_QF92.jpg', 8, '2022-05-06', '2022-05-06');
...
(5, '25000', 'Pengeluaran', '35000', '2022-06-07', 'June', 'Pengeluaran Pembuatan Terasi Dengan Kode Produk KP_nvX1');
...
--
ALTER TABLE `informasipemesananterasi`
  MODIFY `id_informasiPemesananTerasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `pembayaranpembeliterasi`
  MODIFY `id_pembayaranPembeliTerasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
